...
export default function ContactMain() {
  return (
    <main className="">
      ...
      <section className="mx-auto mt-20 mb-20 flex w-full max-w-9/12 items-start gap-6 rounded-lg border border-white/10 bg-black px-8 py-8">
        ...
        <article className="relative h-full min-h-[500px] w-full flex-1">
          <ContactSpline />
