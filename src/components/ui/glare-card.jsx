...
export const GlareCard = ({ children, className }) => {
  ...
  return (
    <div
      ...
      className="relative isolate mx-auto [aspect-ratio:17/21] w-11/12 transition-transform delay-[var(--delay)] duration-[var(--duration)] ease-[var(--easing)] will-change-transform [contain:layout_style] [perspective:600px] min-[500px]:w-[clamp(260px,22vw,390px)]"
      ref={refElement}
      onPointerMove={(event) => {
